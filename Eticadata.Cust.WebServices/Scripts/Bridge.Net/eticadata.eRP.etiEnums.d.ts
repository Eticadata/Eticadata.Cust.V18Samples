...
declare module Eticadata.ERP.EtiEnums {
    export enum TpDBs {
        AllDBs = 0,
        EticadataDBs = 1,
        EtiSistemas = 2,
    ...
    export enum tpFiltroEmpresa {
        Activas = 0,
        Inactivas = 1,
        ActivasInactivas = 2
    }

    export enum TpConfiguracaoAvisos {
        NaoEmitir = 0,
        MostraUmaVezDia = 1,
        PendentesCliOD = 2,
        PendentesForOC = 3,
    ...
    export enum TpCondicoesCompras {
        FornecedorArtigos = 1,
        ArtigoFornecedores = 2
    }

    export enum TpCompra {
        Compra = 0,
        Encargo = 1
    }

    export enum TpComponente {
        BarraBotoes = 0,
        PainelGrupos = 1,
        PainelSubGrupos = 2,
        PainelArtigos = 3,
    ...
    export enum TpDocumentoAEmitir {
        Stocks = 1,
        Vendas = 2,
        Compras = 3,
        Orcamentos = 4,
    ...
    export enum TpEncomenda {
        Cliente = 0,
        Fornecedor = 1,
        Armazem = 2
    }

    export enum TpEntidade {
        Cliente = 0,
        OutroDevedor = 1,
        Fornecedor = 2,
        OutroCredor = 3,
    ...
    export enum TpCmpArtigos {
        simples = 0,
        inventario = 1,
        transformacao = 2
    }

    export enum TipoCustoArtigo {
        PC_MEDIO = 1,
        PC_REFERENCIA = 2,
        PC_ULTIMO = 3,
        PC_VENDA = 4,
    ...
    export enum TpGranel {
        Quantidade = 1,
        Preco = 2
    }

    export enum ReportApplication {
        FrontOffice = 1,
        BackOffice = 2,
        Mobile = 3
    }

    export enum RestricoesMovFiliais {
    ...
    export enum SerieDescontinuada {
        AbrevTpDocumento = 0,
        Seccao = 1,
        SerieStatus = 2
    }
    ...
    export enum TaxTypeCalculation {
        Legacy = 0,
        Mixed = 1,
        Complex = 2
    }

    export interface TipificationJournalSAFT {
    }
    export interface TipificationJournalSAFTFunc extends Function {
        prototype: TipificationJournalSAFT;
        new (): TipificationJournalSAFT;
        cNormal: string;
        cReg: string;
        cApur: string;
        cMovsAjus: string;
    }
    var TipificationJournalSAFT: TipificationJournalSAFTFunc;

    export enum TipoDocStockMov {
        Entrada = 0,
        Saida = 1,
        Transferencia = 2,
        FolhaObra = 3,
    ...
    export enum TipoEntidadeContacto {
        Contacto = 0,
        Cliente = 1,
        Fornecedor = 2,
        OutroDevedor = 3,
    ...
    export enum TipoParametrizacao {
        ParamDeclper = 1,
        ParamDeclAnu = 2,
        ParamM22 = 3,
        ParamDeclPerAnt = 4,
    ...
    export enum TiposNumeracao {
        Mensal = 0,
        Anual = 1,
        Continuo = 2
    }

    export enum TiposNumeradores {
        tpGestaoComercial = 1,
        TpComissoes = 2,
        tpTaloesDep = 3,
        tpReconciliacoes = 4,
    ...
    export enum TpGrupoBarraBotoes {
        Movimento = 0,
        EdicaoLinha = 1,
        GestaoCaixa = 2,
        Outras = 3,
    ...
    export enum TpTesTipoConta {
        Banco = 1,
        Caixa = 2
    }

    export enum TpImportacaoGOLD_Origem {
        cGceCteOfiStd = 0,
        cInvestimento = 1,
        cRecurHumanos = 2
    }

    export enum TpRepTabelasContinuacao {
        pTodas = 1,
        pIESAnexo_A = 2,
        pIESAnexo_D = 4,
        pIESAnexo_F = 8,
        ...
        peMedical_Marks = 4294967296,
        peMedical_MCDTAreas = 8589934592,
        peMedical_Benefits = 17179869184,
        peMedical_CliniHistory = 34359738368,
        peMedical_ConsulState = 68719476736,
        peMedical_Specialty = 137438953472,
        peMedical_ResponsibleFinancialInstitution = 274877906944,
        peMedical_Standard = 549755813888,
        peMedical_TypeDosages = 1099511627776,
        peMedical_TypeMedicalBenefit = 2199023255552,
        peMedical_TypeMedicalCards = 4398046511104,
        peMedical_TypeMedicalConsul = 8796093022208,
        peMedical_TypeMedicalDeclarations = 17592186044416,
        peMedical_TypeModTaxExemptions = 35184372088832,
        peMedical_TypePrints = 70368744177664,
        peMedical_TypeProfessionalBodies = 140737488355328,
        peMedical_TypeRFI = 281474976710656,
        peMedical_DCIPT = 562949953421312,
        peMedical_PharmaceuticalForm = 1125899906842624,
        peMedical_MedicPrescState = 2251799813685248,
        peMedical_MedicPrescReasonsAnnulment = 4503599627370496,
        peMedical_MedicPrescType = 9007199254740992,
        peMedical_MedicPrescVia = 18014398509481984,
        peMedical_MedicPrescExceptions = 36028797018963968,
        peMedical_ClinicHistSpecialty = 72057594037927936,
        pImpostos = 144115188075855872,
        peMedical_Lateralidade = 288230376151711744,
        peMedical_Object = 576460752303423488,
        peMedical_MCDTAgree = 1152921504606846976,
        peMedical_AnnulamentReasonLine = 2305843009213693952
    }

    export enum TpStatusBar {
        Utilizador = 0,
        Empresa = 1,
        Exercicio = 2,
        Licenca = 3,
    ...
    export enum TpTESDocumentoOrigem {
        Tesouraria = 1,
        Vendas = 2,
        RecibosVendas = 3,
        Compras = 4,
    ...
    export enum TpUnidade {
        STK = 1,
        VND = 2,
        CMP = 3
    }

    export enum TpValoresDescarga {
        ValorTotal = 100,
        ValorDoIVA = 101,
        ValorLiquido = 102,
        DescontoNormal = 103,
    ...
    export enum VoucherBirthdayTpDate {
        Birthday = 0,
        Birth = 1
    }

    export enum VoucherComputedStates {
        Available = 0,
        Used = 1,
        Canceled = 2,
        Annulled = 3,
    ...
    export enum VoucherCustomEventsTypes {
        ApplicationDoc = 0,
    ...
    export enum TpRepTabelas {
        ...
        pGrh_NaturezasJuridicas = 4294967296,
        pGrh_Paises = 8589934592,
        pGrh_Profissoes = 17179869184,
        pGrh_ReparticaoFinancas = 34359738368,
        pGrh_ResultadosConsultas = 68719476736,
        pGrh_Seguradoras = 137438953472,
        pGrh_SegurancaSocial = 274877906944,
        pGrh_SituacoesCGA = 549755813888,
        pGrh_Sindicatos = 1099511627776,
        pGrh_Situacoes = 2199023255552,
        pGrh_TaxasIRS = 4398046511104,
        pGrh_TiposRendimentos = 8796093022208,
        pGrh_TiposDespesas = 17592186044416,
        pGrh_TiposContrato = 35184372088832,
        pGrh_TiposExames = 70368744177664,
        pGrh_Turnos = 140737488355328,
        pAut_ConfigAuto = 281474976710656,
        pAut_RentAcar = 562949953421312,
        pAut_ConfigProc = 1125899906842624,
        pGrh_Config_Desc_CTE = 2251799813685248,
        pGrh_MapasEspecificos = 4503599627370496,
        pAut_Oficinas = 9007199254740992,
        pGrh_RelatorioUnicoParam = 18014398509481984
    }

    export enum VoucherKinds {
        Discount = 0,
        Refund = 1
    }
    ...
    export enum VoucherValDateEndNumDaysAddTypes {
        NumberOfDaysAfterStarting = 0,
        LastDayOfTheStartMonth = 1
    }

    export enum VoucherValDateEndTypes {
        EndNumDaysAfter = 0,
        EndFixedDate = 1
    }

    export enum VoucherValDateStartNumDaysAddDateTypes {
        Emission = 0,
        Birthday = 1
    }

    export enum VoucherValDateStartNumDaysAddTypes {
        NumberOfDaysAfter = 0,
        FirstDayOfMonth = 1
    }

    export enum VoucherValDateStartTypes {
        StartNumDaysAfter = 0,
        StartFixedDate = 1
    }

    export enum VoucherValueApplyMethod {
        Accumulate = 0,
        Overwrites = 1
    }

    export enum VoucherValueTypes {
        Value = 0,
        Percentage = 1
    }
    ...
    export enum RastreabilidadeArtMovs {
        Encomendas = 0,
        Compras = 1,
        Producoes = 2,
        Stocks = 3,
    ...
    export enum VoucherQueryIncludeTypes {
        IncludeValue = 0,
        IncludePercentage = 1
    }

    export enum TpQtdStock {
        cStockMinimo = 0,
        cStockMaximo = 1,
        cStockReposicao = 2
    }

    export enum TpPromocaoTipo {
        Artigo = 1,
        Familia = 2,
        Referencia = 3
    }

    export enum TpPromocao {
        None = 0,
        LeveXpagueY = 1,
        NovoPreco = 2,
        Desconto = 3,
    ...
    export enum TpInvocEntid {
        CodEntidade = 1,
        ECVDNumContrib = 2,
        ECVDNome = 3
    }

    export enum TpKeyPress {
        Nada = 0,
        EnterPress = 1,
        CancelLeaveCell = 2,
        AddPress = 3,
    ...
    export enum TpMercado {
        Nacional = 0,
        Comunitaria = 1,
        ExtraComunitaria = 2
    }

    export enum TpModulosADM {
        cModAdmCte = 1,
        cModAdmGce = 2,
        cModAdmImo = 4,
        cModAdmSTD = 8,
    ...
    export enum TpMovTesouraria {
        Previsto = 0,
        Real = 1,
        DefTpPag = 2
    }

    export enum TpNaturezaContrato {
        NaoDefinido = 0,
        Generico = 1,
        Viaturas = 2,
        Equipamentos = 3
    ...
    export enum TpOperacao {
        Localizacoes = 1
    }

    export enum TpOperacaoDocOriginal {
        Nenhuma = 0,
        Anular = 1,
        Relacionar = 2,
     ...
     */
    export enum TpParametroRpt {
        Formula = 0,
        Parametro = 1
    }

    export enum TpPendente {
    ...
    export enum EnumTypeLinkCategory {
        ValorImposto = 1,
        ValorIncidencia = 2,
    ...
    export enum EntidadeEstabelecimento {
        ArtigoEstabelecimentos = 1,
        EstabelecimentoArtigos = 2
    }

    export enum enumAvisosExportacao {
        SemVendedores = 1,
        SemArtigos = 2,
        ArtigosInactivos = 3,
        ArtigosLotes = 4,
    ...
    export enum enumCRM_CodType {
        DocumentType = 0,
        ActivityType = 1
    }

    export enum enumCRM_Condition {
        And = 0,
        Or = 1
    }

    export enum enumCRM_MarketingType {
        Advertising = 1,
        DirectMarketing = 2,
        Event = 3,
        Other = 4
    ...
    export enum enumCRM_MessageType {
        Obs = 0,
        Fixed = 1
    }

    export enum enumCRM_OrganizerType {
        CurrentUser = 0,
        Other = 1
    }

    export enum enumCRM_RuleCompare {
        Field = 0,
        Value = 1
    }

    export enum enumCRM_RuleType {
        None = 0,
        Execute = 1,
        Multiple = 2
    }

    export enum enumCRM_StartDateType {
        Equal = 0,
        Before = 1,
        After = 2
    }

    export enum enumCRM_Status {
        Open = 1,
        Suspended = 2,
        Concluded = 3
    }

    export enum enumCRM_VariationType {
        Seconds = 0,
        Minutes = 1,
        Hours = 2,
        Days = 3,
    ...
    export enum enumOrdemMovsCaixa {
        Abertura = 1,
        Dia = 2,
        Fecho = 3,
        ValorEmExcesso = 4,
    ...
    export enum EnumOrigemAccaoMedica {
        Manual = 0,
        FactorRiscoDoenca = 1,
        FactorRisco = 2,
        AcidenteTrabalho = 3
    ...
    export enum DescargaContabilidade {
        ON_LINE = 0,
        OFF_Line = 1,
        Exportacao = 2
    }

    export enum DataCollectionInfoType {
        BankStatement = 1,
        eInvoice = 2
    }

    export interface AbrevTipificationJournalSAFT {
    }
    export interface AbrevTipificationJournalSAFTFunc extends Function {
        prototype: AbrevTipificationJournalSAFT;
        new (): AbrevTipificationJournalSAFT;
        cNormal: string;
        cReg: string;
        cApur: string;
        cMovsAjus: string;
    }
    var AbrevTipificationJournalSAFT: AbrevTipificationJournalSAFTFunc;

    export enum ActiveCaseResult {
        Allowed = 1,
        Forbidden = 2,
    ...
    export enum ActPrecosVendaModoArred {
        Aritmetico = 0,
        ParaCima = 1,
        ParaBaixo = 2,
        ParaCimaX5 = 3,
    ...
    export enum ActPrecosVendaPrecoBase {
        PrecoActual = 0,
        PrecoCustoUltimo = 1,
        PrecoCustoMedio = 2,
        PrecoReferencia = 3,
    ...
    export enum ActPrecosVendaTipoCalculo {
        Linear = 0,
        Simples = 1,
        Forte = 2,
        SimplesArt = 3,
    ...
    export enum Anexos_TipoFicheiro {
        Report = 0,
        FicheiroBD = 1,
        FicheiroDir = 2
    }

    export enum Avisos_Grelhas_ActivacaoSQLNotificationQuery {
        Codigo = 1,
        Designacao = 2,
        bdados = 3,
        EmpSelect = 4
    ...
    export enum CamposFiltroChequesValesValesdesconto {
        CodigoDescricao = 0,
        Codigo = 1,
        Descricao = 2,
        Descontado = 3,
    ...
    export enum ClassificationTypeDiverseProduct {
        MerchandiseServices = 0,
        Others = 1
    }

    export enum DecretosLei {
        DL_P_20258 = 1,
        DL_126_77 = 2,
        DL_430_78 = 3,
        DL_24_82 = 4,
    ...
    export enum CommunicationOrigin {
        CompensationFunds = 0,
        Employee = 1,
        CeaseContract = 2
    }
    ...
    export enum ConfigEmpresaExerc {
    ...
    export enum ConfigGrelhaTpGrelha {
        EtiDataGrid = 0,
        EtiSpread = 1,
        TreeGridView = 2,
        UltraGrid = 3
    ...
    export enum ConfigUserEmpExerc {
        tActualizaData = 1,
    ...
    export enum EmpresaTpManutencao {
        Desactualizada = 0,
        EmManutencao = 1,
        Actualizada = 2
    }

    export enum EnumResultadoAcidente {
    ...
    export enum ExportWebFormat {
        NENHUM = 0,
        PDF = 1,
        Excel = 2
    }

    export enum FieldsERP_BankStatement {
        ValueDate = 1,
        MovementDate = 2,
        Value = 3,
        DebitValue = 4,
    ...
    export enum FieldsERP_eInvoice {
        Entity = 1,
        DocType = 2,
        DocNumber = 3,
        IssueDate = 4,
    ...
    export enum GENDescontosPrecosEntidade {
    ...
    export enum GratificationType {
        Percentage = 0,
        Value = 1,
        Total = 2
    }

    export enum Grelhas_Geral_TabelasListagens {
        Campo = 1,
        Imprimir = 2,
        Posicao = 3,
        Ordenar = 4,
    ...
    export enum GS_ValueOfProperty {
        None = -1,
        Group = 0,
        SubGroup = 1,
    ...
    export enum GTMotive_TpOperacao {
        Create = 1,
        Update = 2,
        Read = 3,
        Report = 4,
    ...
    export enum InactiveFieldsPosition {
        ErrorCode = 0,
        Property = 1,
        TableEnum = 2,
        RecordValue = 3,
    ...
    export enum ItemMenuOpenWindow {
        CheckCompanyFile = 0,
        Yes = 1,
        No = 2
    }

    export enum JanelaDescargaCTB {
        cINDEXCTBCompras = 1,
        cINDEXCTBStocks = 2,
        cINDEXCTBVendas = 3,
    ...
    export enum LinhaLicenca {
        Base = 0,
        Premium = 1,
        Extended = 2
    }

    export enum LockedBySettlementCode {
        NotLocked = 0,
        HasManualSettlements = 1,
        HasAutomaticSettlementLocked = 2
    }

    export enum MaxEmbebbedScrollButtonsSizeSchema {
        DefValue = 0,
    ...
    export enum enumPermEntidade {
        Utilizadores = 0,
        Grupos = 1,
        Empresas = 2
    }

    export enum EVCasasDec {
        Pilhas = 4,
        Pneus = 4,
        Oleos = 4,
        REEE = 4,
    ...
    export enum EtiStateResponse {
        OK = 0,
        Warning = 1,
        Error = 2
    }

    export enum EtiqTpEmissao {
        NaoDefinido = -1,
        NumFixoCopias = 0,
        StockReal = 1,
        MovStocks = 2,
    ...
    export enum enumSalesComissionType {
        None = 0,
        SessionClosing = 1,
        SaveSales = 2
    }

    export enum enumTabArtigos {
        Precos = 0,
        OutrosDados1 = 1,
        OutrosDados2 = 2,
        StockCodBarras = 3,
    ...
    export enum EnumTipoAccoesMedicas {
        Exame = 1,
        Consulta = 2,
        Vacinação = 3,
        Informação = 4,
    ...
    export enum EnumTipoAccoesSemLicenca {
        Exame = 1,
        Consulta = 2
    }

    export enum EnumTipoAcidente {
        NoLocalDeTrabalho = 0,
        ACaminhoDoLocalDeTrabalho = 1
    }

    export enum enumTipoDialogo {
        SaveDialog = 0,
        FolderDialog = 1,
        OpenDialog = 2,
        FileDialogEti = 3,
     ...
     */
    export enum EnumTiposExames {
        Admissao = 0,
        Periodico = 1,
        Ocasional = 2
    }

    export enum EnumTiposProfissional {
        Médico = 0,
        Enfermeiro = 1,
    ...
    export enum PanelButtonsScrollTypes {
    ...
    export enum EnumTiposProfissionalSemLincenca {
        Médico = 0
    }

    export enum enumTpAccaoMsg {
        Nao_Definido = 0,
        Sim = 1,
        Não = 2,
        Sim_Para_Todos = 3,
    ...
    export enum POSv2MsgBoxButtonType {
        None = 0,
        TransformDoc = 1,
        ActiveCase = 2
    }

    export enum enumValuePermEntidade {
        UserSemPerm = 0,
        UserComPerm = 1,
        UserSemPermGrupo = 2,
        UserComPermGrupo = 3
    ...
    export enum enumVendedorTpComissaoStd {
        PVSemIva = 0,
        PVSemAverbIA = 1,
        Lucro = 2
    }

    export enum EtiApplication {
        None = 0,
        BackOffice = 1,
        FrontOffice = 2,
    ...
    export enum EtiApplicationModule {
        None = 0,
        Sales = 1,
        Purchases = 2,
        Orders = 3,
    ...
    export interface EtiConstComuns {
    }
    export interface EtiConstComunsFunc extends Function {
        prototype: EtiConstComuns;
        new (): EtiConstComuns;
        cDATANULL: string;
        cDATAFORMAT: string;
        cDateSTDFormat: string;
        cDateTimeSTDFormat: string;
        cMaxNumSerie: number;
        cMaxCodigoLote: number;
        cMaxDescricaoArtigo: number;
    }
    var EtiConstComuns: EtiConstComunsFunc;

    export interface EtiFileManagerFilter {
    }
    export interface EtiFileManagerFilterFunc extends Function {
        prototype: EtiFileManagerFilter;
        new (): EtiFileManagerFilter;
        GetFilterType(pFilterType: Eticadata.ERP.EtiEnums.FilterType): string;
    }
    var EtiFileManagerFilter: EtiFileManagerFilterFunc;

    export enum etiMetaModulos {
        CC = 1,
        Compras = 2,
        CTE = 3,
