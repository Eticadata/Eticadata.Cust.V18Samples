 ...
 */
 ...
 declare module Bridge {
    ...
    export interface Guid {
        ...
        parse(uuid: string, format: IFormatProvider): Guid;
        tryParse(uuid: string, format: IFormatProvider, r: { v: Guid }): boolean;
        format(uuid: string, format: IFormatProvider): string;
        fromBytes(b): Guid;
        newGuid(): Guid
        getBytes(uuid): any[];
    }
